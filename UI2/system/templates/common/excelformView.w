...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" class="window">
	...
	<div class="row form-navbar1" style="margin-top:12px">
		<label for="text1" class="control-label col-xs-2" style="padding-top:10px;margin-left:15px" xid="control"><![CDATA[详细页配置：]]></label>
		<div class="col-xs-4" xid="col1" style="display:none">
			<input component="$UI/system/components/justep/input/input" class="form-control" xid="titleInput" placeholder="请输入标题" onChange="input1Change" style="display:none"/>
		</div>
	</div>
