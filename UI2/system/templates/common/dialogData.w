      ...
      <rule xid="rule4"> 
        <col name="dataId" xid="ruleCol3"> 
          <readonly xid="readonly3"> 
            <expr xid="default20">js:val('dataId')=="dialogData"</expr> 
          </readonly>  
          <required> 
        ...
        <div class="form-group"> 
          ...
          <div class="col-xs-9"> 
            <div class="input-group input-append"> 
              <output component="$UI/system/components/justep/output/output" class="form-control template-dialog-output-control"
...
<!--           <span>  -->
<!--             <a class="btn btn-default" component="$UI/system/components/justep/button/button" -->
<!--               bind-click="selectDataBtnClick" style="margin-left:70%" bind-disable="true">从主数据选择</a>  -->
<!--           </span>  -->
<!--         </div>   -->
        <!--         <div class="form-group">  -->  
