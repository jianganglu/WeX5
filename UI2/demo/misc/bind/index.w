      ...
      <rule xid="rule1"> 
        <col name="foodCount" xid="ruleCol1"> 
          <calculate xid="calculate1"> 
            <expr xid="default17">$model.comp('foodData').count()</expr> 
          </calculate> 
        </col>  
        <col name="enabledFoodCount" xid="ruleCol2"> 
          <calculate xid="calculate2"> 
            <expr xid="default18">$model.comp('foodData').count(function(e){return e.row.val('fStatus') == 1;})</expr> 
          </calculate> 
        </col> 
      </rule> 
    </div>  
